...
class Order(models.Model):
    ...
    signal_price = models.DecimalField(max_digits=15, decimal_places=5, null=True)
    limit_price = models.DecimalField(max_digits=15, decimal_places=5, null=True)
    stop_price = models.DecimalField(max_digits=15, decimal_places=5, null=True)
    trailing_amount = models.DecimalField(max_digits=15, decimal_places=5, null=True)
    trailing_percent = models.DecimalField(max_digits=15, decimal_places=5, null=True)

    avg_fill_price = models.DecimalField(max_digits=15, decimal_places=6, null=True)
