!function (e, s) {
  ...
  class r {
    ...
    _updateDataForSubscriber(e) {
      const s = this._subscribers[e], t = parseInt((Date.now() / 1e3).toString()),
        r = t - function (e, s) {
          let t = 0;
  ...
  class a {
    ...
    _onExchangeDataReceived(e, s) {
      ...
      try {
        ...
        for (; t < e; ++t) {
          const e = s.symbol[t], o = i(s, "exchange-listed", t),
            a = i(s, "exchange-traded", t), c = a + ":" + e,
            h = i(s, "currency-code", t), l = i(s, "unit-id", t),
            d = r ? i(s, "ticker", t) : e, _ = {
              ticker: d,
              name: e,
              base_name: [o + ":" + e],
              full_name: c,
